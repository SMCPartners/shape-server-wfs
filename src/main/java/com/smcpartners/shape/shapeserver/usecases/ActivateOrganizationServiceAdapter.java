...
import com.smcpartners.shape.shapeserver.gateway.rest.services.ActivateOrganizationService;
 ...
 */
@Path("/admin")
public class ActivateOrganizationServiceAdapter implements ActivateOrganizationService {
