...
import com.smcpartners.shape.shapeserver.frameworks.data.dao.shape.OrganizationStratificationFileUploadProcessorDAO;
import com.smcpartners.shape.shapeserver.gateway.rest.services.Add_Organization_Stratification_Upload_Service;
 ...
 * 1. Upload a file that contains a measure. All files will be in a consistent MS Word docx format.</br>
 * 2. Keep a record of the file processing, including the file contents must be saved.</br>
 * 3. The data in the file will create or update organizational stratification for an organization</br>
...
public class Add_Organization_Stratification_Upload_ServiceAdapter implements Add_Organization_Stratification_Upload_Service {
     ...
     * Default constructor
     */
    public Add_Organization_Stratification_Upload_ServiceAdapter() {
    }
    ...
    @Logged
    public FileUploadResponseDTO addStratificationUpload(MultipartFormDataInput input,
...
//                    }
//
//                    if (organizationStratificationDAO.checkMeasureForYearForOrgAlreadyEntered(measureId, orgId, rptYear)) {
