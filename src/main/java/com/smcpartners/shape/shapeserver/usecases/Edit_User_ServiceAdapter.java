...
import com.smcpartners.shape.shapeserver.gateway.rest.services.Edit_User_Service;
 ...
 */
@Path("/admin")
public class Edit_User_ServiceAdapter implements Edit_User_Service {
     ...
     * Default Constructor
     */
    public Edit_User_ServiceAdapter() {
    }
